...
namespace SistemaComercial
{
    ...
    public partial class AlunoConsultaRG : Form
    {
        public int codigo = 0;
        public int cadastro = 0;
        public AlunoConsultaRG()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = bll.LocalizarRg(textBox1.Text);
        }

        private void AlunoConsultaRG_Load(object sender, EventArgs e)
        {
