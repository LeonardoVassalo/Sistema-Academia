...
{
    public partial class PesquisaUsuarioUsu : Form
    {
        public int codigo = 0;
        public int cadastro = 0;
        public PesquisaUsuarioUsu()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            dataGridView1.DataSource = bll.LocalizarUsu(textBox1.Text);
        }

        private void PesquisaUsuarioUsu_Load(object sender, EventArgs e)
        {
