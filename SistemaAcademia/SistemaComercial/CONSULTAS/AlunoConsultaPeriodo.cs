...
{
    public partial class AlunoConsultaPeriodo : Form
    {
        public int codigo = 0;
        public int cadastro = 0;
        public AlunoConsultaPeriodo()
        {
            InitializeComponent();
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            BLLCadastroAluno bll = new BLLCadastroAluno(cx);

            dataGridView1.DataSource = bll.LocalizarPeriodo(comboBox1.Text);
        ...
        private void AlunoConsultaPeriodo_Load(object sender, EventArgs e)
        {
